...
int test_groups(void)
{
  ...
  struct space * sp1;
  //struct list *item;
  printf(" test_groups TODO\n");
  sp1 = add_space_in(&g_space_list, "ADD pine4/gpios/gpio10\n", NULL);
  return 0;
  //sp1 = add_space(&g_space, "ADD pine1/gpios/gpio1");
  sp1 = add_space(&g_space_list, "ADD pine4/gpios/gpio2\n");
  sp1 = add_space(&g_space_list, "ADD pine4/gpios/gpio3\n");
  sp1 = add_space(&g_space_list, "ADD pine4/gpios/gpio4\n");
  sp1 = add_space(&g_space_list, "ADD pine4/gpios/gpio5\n");
  sp1 = add_space(&g_space_list, "ADD pine4/gpios/gpio6\n");
  sp1 = add_space(&g_space_list, "ADD red_leds\n");
  sp1 = add_space(&g_space_list, "ADD green_leds\n");
  sp1 = add_space(&g_space_list, "ADD blue_leds\n");
  add_group_member("red_leds", "pine4/gpios/gpio1");
  add_group_member("red_leds", "pine4/gpios/gpio3");
  add_group_member("green_leds", "pine4/gpios/gpio2");
  add_group_member("green_leds", "pine4/gpios/gpio3");
  return 0;
